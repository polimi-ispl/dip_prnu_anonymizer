...
def get_pretrained_net(name):
    ...
    if name == 'alexnet_caffe':
        if not os.path.exists('alexnet-torch_py3.pth'):
            ...
            os.system(
                'wget -O alexnet-torch_py3.pth --no-check-certificate -nc https://box.skoltech.ru/index.php/s/77xSWvrDN0CiQtK/download')
        ...
        if not os.path.exists('vgg19-caffe-py3.pth'):
            ...
            os.system(
                'wget -O vgg19-caffe-py3.pth --no-check-certificate -nc https://box.skoltech.ru/index.php/s/HPcOFQTjXxbmp4X/download')
        ...
        if not os.path.exists('vgg16-caffe-py3.pth'):
            ...
            os.system(
                'wget -O vgg16-caffe-py3.pth --no-check-certificate -nc https://box.skoltech.ru/index.php/s/TUZ62HnPKWdxyLr/download')
